class ZCL_ZSEGW_MDASHBOARD_MPC definition
  public
...
public section.
  ...
  types:
     TS_ZNOTIF type ZMEN_NOTIF_S .
  types:
TT_ZNOTIF type standard table of TS_ZNOTIF .
  types:
  ...
  types:
     TS_ZWORKORDER type ZMEN_WORKO_S .
  types:
TT_ZWORKORDER type standard table of TS_ZWORKORDER .

  constants GC_ZNOTIF type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Znotif' ##NO_TEXT.
  constants GC_ZWORKORDER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZWorkOrder' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_ZNOTIF
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZWORKORDER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZSEGW_MDASHBOARD_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSEGW_MDASHBOARD_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Znotif' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Strmn' iv_abap_fieldname = 'STRMN' ). "#EC NOTEXT
lo_property->set_type_edm_datetime( ).
lo_property->set_precison( iv_precision = 7 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZMEN_NOTIF_S'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZnotifSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZWorkOrder' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Kostv' iv_abap_fieldname = 'KOSTV' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_conversion_exit( 'ALPHA' ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Scope' iv_abap_fieldname = 'SCOPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 2 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZMEN_WORKO_S'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZWorkOrderSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250617083223'.                  "#EC NOTEXT
