class ZCL_ZVENDOR_PROFILEK_MPC definition
  public
...
public section.
  ...
  types:
     TS_ZMM_VPROFILE_S type ZMM_VPROFILE_S .
  types:
TT_ZMM_VPROFILE_S type standard table of TS_ZMM_VPROFILE_S .
  types:
  ...
  constants GC_ZMM_VPROFILE_S type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZMM_VPROFILE_S' ##NO_TEXT.
...
CLASS ZCL_ZVENDOR_PROFILEK_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVENDOR_PROFILEK_SRV' ).

define_zmm_vprofile_s( ).
  endmethod.


  method DEFINE_ZMM_VPROFILE_S.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - ZMM_VPROFILE_S
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZMM_VPROFILE_S' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZMM_VPROFILE_S'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZMM_VPROFILE_SSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250604025602'.                  "#EC NOTEXT
